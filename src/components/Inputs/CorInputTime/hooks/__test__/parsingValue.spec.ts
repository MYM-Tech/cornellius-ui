...
describe('testing parsing value script', () => {
    it('should return true if seconds is available', () => {
    ...
    it('should return false if the format is 24 h', () => {
        const formatType = 'hh:mm:ss';
    ...
    it('should return true if milliseconds is available', () => {
    ...
    it('should return false if milliseconds is not available', () => {
        const formatType = 'hh:mm:ss:';
        const { hasMilliseconds } = parsingTypeFormat(formatType);
    ...
    it('should return the good number of hours when we pass a date', () => {
    ...
    it('should return the good number of hours when we pass a date and the time format', () => {
        const value = new Date('August 19, 1975 15:00:00');
    ...
    it('should return the good number of minutes when we pass and date', () => {
    ...
    it('should return the good number of seconds when we pass and date', () => {
    ...
    it('should return the good number of milliseconds when we pass and date', () => {
